...
CREATE POLICY "Allow public read access" ON trainees FOR SELECT USING (true);
...
-- Create policies for insert/update (you can modify these as needed)
...
CREATE POLICY "Allow insert access" ON trainees FOR INSERT WITH CHECK (true);
CREATE POLICY "Allow update access" ON trainees FOR UPDATE USING (true);
